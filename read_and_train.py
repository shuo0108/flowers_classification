...
tfrecord_dir='/home/hs/flowers_classification_1/data'
image_dir='/home/hs/flowers_classification_1/flower_c'
...
def tfrecord_to_image(tffile_path):
    ...
    with tf.Session() as sess: #开始一个会话
        ...
        for i in range(3500):
            ...
            im.save(FLAGS.image_dir+'/'+str(c)+'_''Label_'+str(b)+'.jpeg')#存下图片
        coord.request_stop()
        coord.join(threads)
...
def main(_):
  ...
  '''
  tffile_path=[FLAGS.tfrecord_dir+"/TFcodeX_%d.tfrecord" % i for i in range(1, 10)]
